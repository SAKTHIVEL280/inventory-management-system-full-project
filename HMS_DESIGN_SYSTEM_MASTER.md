# HMS Design System - Master Structure Guide

A comprehensive design system for Healthcare Management Systems (HMS). This document outlines the foundational elements, components, and patterns for building consistent, accessible, and professional healthcare interfaces.
...
|--------|------------|------|-------|
| Active | `bg-green-100` | `text-green-700` | Active patients, confirmed appointments |
| In-Treatment | `bg-blue-100` | `text-blue-700` | Currently receiving care |
| Pending | `bg-amber-100` | `text-amber-700` | Awaiting action, pending approval |
| Discharged | `bg-slate-100` | `text-slate-600` | Completed, discharged |
| Critical | `bg-rose-500` | `text-white` | Critical alerts, urgent |
...
| **Patients** | `person`, `person_add`, `group` |
| **Medical** | `health_and_safety`, `local_hospital`, `medication` |
| **Actions** | `edit`, `visibility`, `delete`, `save` |
| **Status** | `check_circle`, `warning`, `error`, `info` |
| **Finance** | `payments`, `receipt_long`, `invoice` |
...
<div class="relative">
  ...
  <div class="relative">
    ...
    <input class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none" placeholder="name@hospital.com"/>
  </div>
</div>
```
...
<div class="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
  ...
  <div class="flex items-baseline gap-2">
    ...
    <span class="text-[10px] font-bold text-emerald-500">+8.4%</span>
  </div>
</div>
```
  ...
  <div class="p-6">
    ...
    <div class="flex items-center gap-2 mb-8">
      <div class="w-8 h-8 bg-primary rounded flex items-center justify-center">
        <span class="material-icons text-white text-sm">health_and_safety</span>
      </div>
      <span class="font-bold text-lg">HMS Core</span>
    </div>
...
- **Figma File**: [Design System Library]
- **GitHub Repository**: [Component Library]
- **Documentation**: [Storybook / Docs Site]

---

*This design system is built for healthcare professionals. Prioritize clarity, accessibility, and efficiency in all implementations.*
