...
3. **[HMS Design System](./docs/design/HMS_DESIGN_SYSTEM_MASTER.md)** — UI/UX guidelines
...
| **Database** | PostgreSQL 15+ (SQLite option for dev) |
| **Auth** | JWT + bcrypt |
...
│       └── HMS_DESIGN_SYSTEM.md    # Design system
│
...
└── design/
    └── HMS_DESIGN_SYSTEM.md    # Colors, typography, components
```
