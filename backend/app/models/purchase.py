...
class PurchaseOrder(Base):
    ...
    under_delivery_tolerance = Column(Numeric(10, 2), nullable=False, default=0)
    over_delivery_tolerance = Column(Numeric(10, 2), nullable=False, default=0)
...
class GRNItem(Base):
    ...
    quantity = Column(Numeric(12, 4), nullable=False)
    free_quantity = Column(Numeric(12, 4), nullable=False, default=0)
    unit_price = Column(Integer, nullable=False)
    discount_percent = Column(Numeric(5, 2), nullable=False, default=0)
    discount_amount = Column(Integer, nullable=False, default=0)
    taxable_amount = Column(Integer, nullable=False)
