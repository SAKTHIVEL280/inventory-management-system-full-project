...
export const AppLayout = ({ title, children }: AppLayoutProps) => {
  ...
  const navItems: NavItem[] = [
    ...
    { to: '/company', label: 'Company', visible: can('company_read'), icon: 'corporate_fare' },
    { to: '/users', label: 'Users', visible: can('users_read'), icon: 'groups' },
        ...
        <aside className="hidden w-64 shrink-0 border-r border-neutral-200 bg-white lg:block">
          <div className="p-6">
            <div className="mb-8 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-primary">IMS Core</p>
          ...
          <header className="border-b border-neutral-200 bg-white px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-neutral-500">Healthcare and inventory operations</p>
              </div>
